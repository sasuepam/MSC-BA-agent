...
**Project location:** `/Users/sarahsuda/Documents/MSC-BA-agent-Version_1.1`  
...
**Agent file:** `agents/functional-spec-generator.md`  
...
### ba-story-generator
**Agent file:** `agents/ba-story-generator.md`  
**Input:** HTML spec from `output/specs/`  
**Output:** `output/stories/<req-id>-[initiative-slug]-cr-001.md`, `output/stories/<req-id>-[initiative-slug]-us-001.md` — one file per story  
...
### ba-validator
**Agent file:** `agents/ba-validator.md`  
...
### jira-publisher
**Agent file:** `agents/jira-publisher.md`  
...
**Agent file:** `agents/confluence-publisher.md`  
...
Stored in: `knowledge/templates/`

| Template | File | Use For |
|---|---|---|
| User Story | `user_story_template.html` | New interface stories |
| Mulesoft Requirements | `functional_specification_template.html` | Source template for functional spec structure |
...
### Output file naming
- Functional spec: `functional_spec_<req-id>_[feature_name_snake_case].html` (e.g. `functional_spec_NEW-0042_timezone_management.html`)
